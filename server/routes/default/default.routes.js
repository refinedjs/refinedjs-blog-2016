	...
	*/
	function setRoutes( app ) {
		...
		app.route( "/" ).get(function( req, res ){
			res.render( 'index', { post : { page_title : "The Pursuit To Refining Javascript", meta_desc : meta_desc } });
		});
		app.route( "/contributors" ).get(function( req, res ){
			res.render( 'contributors', { post : { page_title : "Our Contributors", meta_desc : meta_desc } });
		});
		app.route( "/why" ).get(function( req, res ){
			res.render( 'why', { post : { page_title : "Why Did We Start Refined JS?", meta_desc : meta_desc } });
		});
